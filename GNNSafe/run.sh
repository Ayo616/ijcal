...
python main.py --method gnnsafe --backbone gcn --dataset twitch --mode detect --use_bn --use_prop --use_reg --m_in -9 --m_out -2 --lamda 0.01 --device 1 --oodloss 1 --recession 1
